package de.nicolas.sfs.resources;
...
public class Assets {
    ...
    private void loadGameplayAssets(){
        ...
        assetManager.load(FRONT_ROPES_TEXTURE, Texture.class);
        assetManager.load(IDLE_SPRITE_SHEET, Texture.class);
        assetManager.load(WALK_SPRITE_SHEET, Texture.class);
        assetManager.load(PUNCH_SPRITE_SHEET, Texture.class);
        assetManager.load(KICK_SPRITE_SHEET, Texture.class);
        assetManager.load(HURT_SPRITE_SHEET, Texture.class);
        assetManager.load(BLOCK_SPRITE_SHEET, Texture.class);
        assetManager.load(WIN_SPRITE_SHEET, Texture.class);
        assetManager.load(LOSE_SPRITE_SHEET, Texture.class);
        assetManager.load(GAMEPLAY_BUTTONS_ATLAS, TextureAtlas.class);
        assetManager.load(BLOOD_ATLAS, TextureAtlas.class);
    }
